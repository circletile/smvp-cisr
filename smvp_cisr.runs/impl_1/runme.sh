...
HD_PWD='E:/Documents/Vivado/Basys3/Projects/smvp_cisr/smvp_cisr.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log smvp_cisr_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source smvp_cisr_top.tcl -notrace
