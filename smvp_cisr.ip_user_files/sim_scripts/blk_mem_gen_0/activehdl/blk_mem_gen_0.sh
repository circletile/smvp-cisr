...
#
# Generated by Vivado on Sat Apr 24 12:26:42 -0400 2021
...
map_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="E:/Documents/Vivado/Basys3/Projects/smvp_cisr/smvp_cisr.cache/compile_simlib/activehdl"
  fi
