...
HD_PWD='E:/Documents/Vivado/Basys3/Projects/smvp_cisr/smvp_cisr.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log smvp_cisr_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source smvp_cisr_top.tcl
